...
focus:
  ...
  - Generative AI
currently_learning:
  - SQL → subqueries, EXISTS/ANY/ALL, views, indexes
...
### 🔗 ChainGuard
**SAP HackFest 2026 — North India Finalist**
[View Repo](https://github.com/varunntech/Ai-demand-forecasting)

A multi-agent predictive and self-healing resilience network for critical supply chains — built with team **BlueLock**. Detects disruptions early, scores impact by cost, delay, and human criticality, and recommends recovery automatically.

- 🔮 Predictive disruption detection
- ⚖️ Human-impact-aware risk scoring
- 🔁 Self-healing recovery loop
- 🔒 Blockchain-backed, tamper-evident audit trail

`AI Agents` `Supply Chain` `Predictive Modeling`

</td>
<td width="50%" valign="top">

### 🩺 Gastric-Care
[View Repo](https://github.com/varunntech/Gastric-Care)

A healthcare-focused web project built to help track and manage gastric health information for users.
...
[View Repo](https://github.com/varunntech/Employee-Management-System)

Built with Python OOP concepts — CRUD operations, CSV file handling, exception handling, and Pandas-based employee data analysis.
...
[View Repo](https://github.com/varunntech/Netflix-Data-Analysis)

Exploratory data analysis on Netflix content data using Jupyter Notebook.
